...
plugins=(git virtualenv nvm adb kubectl zsh-syntax-highlighting zsh-completions aws docker zsh_reload zsh-navigation-tools github zsh-256color colored-man-pages zsh-autosuggestions dotenv)
